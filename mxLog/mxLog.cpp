    ...
    else
    {
        ...
        switch( format )
        {
            case 'u':{
                ...
                snprintf( outBuf, bufSIZE, "%lu", *static_cast<const uint32_t*>(pluPar) );}
                break;
            ...
            case 'x':{
                ...
                uint32_t* pluPar = (uint32_t*)&parBuf[0];
                snprintf( outBuf, bufSIZE, "%lx", *static_cast<const uint32_t*>(pluPar) );}
                break;
            ...
            case 'd':{
                ...
                snprintf( outBuf, bufSIZE, "%ld", *static_cast<const int32_t*>(pdPar) );}
                break;
            ...
            case 'g':{
                ...
                snprintf( outBuf, bufSIZE, "%g", *static_cast<const double*>(pgPar) );}
                break;
...
/**
  * @brief  Print out manager. Must be continuously called in main loop or in a OS task
